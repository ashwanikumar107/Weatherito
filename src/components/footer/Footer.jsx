...
function Footer() {
  ...
  return (
    <footer className={styles.footer}>
      ...
      <p>
        <sup>&#169; </sup>
        {currentYear} <span className={styles.myName}>Ashwani Kumar</span>
      </p>
      <div className={styles.links}>
        <a
          href="https://www.linkedin.com/in/ashwani-kumar-b33534298/"
        ...
        <a
          href="https://github.com/ashwanikumar107"
